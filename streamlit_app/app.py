...
# industry_list = metadata_df["Industry"].unique().tolist()
...
# filtered_locations = metadata_df[metadata_df["Industry"] == selected_industry]["Location"].unique().tolist()
# selected_location = st.selectbox("Select a location:", filtered_locations)
